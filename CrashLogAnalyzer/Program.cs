...
public partial class Program
{
    ...
    private async Task ReadyAsync()
    {
        SlashCommandBuilder interferenceCommand = new SlashCommandBuilder()
            ...
            .WithDescription("Print current known inferfeering software");
        ...
        if (message.Attachments.Count > 0)
        {
            ...
            for (int i = 0; i < message.Attachments.Count; i++)
            {
                ...
                if (log.HasValidContent)
                {
                    ...
                    embedBuilder.WithDescription("Summary of the log");
                    ...
                    switch (log.ArcDPS.Method)
                    {
                        ...
                        case LoadMethod.Nexus:
                            ...
                            break;
                        default:
                            AddEmbedNotEmptyField(embedBuilder, "ArcDPS", log.ArcDPS.Build);
                            break;
                    }
                ...
                {
                    ConsoleTrace("Attachment with incorrect format, skipping parsing.");
